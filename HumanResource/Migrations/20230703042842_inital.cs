    ...
    public partial class inital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NavMenus", x => x.PageId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StrCodes", x => x.CategoryCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.EmpNo, x.PageId });
                    table.ForeignKey(
                        name: "FK_RolePageId",
                        column: x => x.PageId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagrApprFlag = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    ...
                    StrManagrApprFlag = table.Column<int>(type: "NUMBER(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancelFlage = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    StrManagerAppr = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    StrManagerApprReson = table.Column<string>(type: "NVARCHAR2(150)", maxLength: 150, nullable: true),
                    ItemQutReceived = table.Column<int>(type: "NUMBER(10)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StrDetails_Code",
                        column: x => x.CategoryCode,
                        principalTable: "StrCategoryCodes",
                        principalColumn: "CategoryCode",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StrDetails_Codes",
                        column: x => x.ItemCode,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StrItemCodes_Code",
                table: "StrItemCodes",
                column: "CategoryCode");

            migrationBuilder.CreateIndex(
                name: "IX_StrReq_EmpNo",
                table: "StrReqMstrs",
                column: "VempDtlEmpNo");
